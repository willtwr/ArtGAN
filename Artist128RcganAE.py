...
gen_dir, real_dir, gen_dir128 = createfolders("./genimgs/Artist128RcganAE", "/gen", "/real", "/gen128")
# Create folder to store models
dir_name = './models/Artist128RcganAE'
...
root_files = '/home/william/PyProjects/TFcodes/dataset/wikiart'
