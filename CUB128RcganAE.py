...
genstl_dir, realstl_dir, gen_dir128 = createfolders("./genimgs/CUB128RcganAE", "/gen", "/real", "/gen128")
# Create folder to store models
dir_name = './models/CUB128RcganAE'
...
root_files = '/home/william/PyProjects/TFcodes/dataset/cub200'
