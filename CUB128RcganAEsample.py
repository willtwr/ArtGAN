...
gen_dir, gen_dir128 = createfolders("./genimgs/CUB128GANAEsample", "/gen", "/gen128")
...
iny = tf.constant(np.eye(n_classes, dtype=np.float32)[batch_size:, :])  # uncomment to generate second 100 classes
...
with tf.Session(config=config) as sess:
    ...
    saver.restore(sess=sess, save_path='./models/CUB128RcganAE2/cdgan29999.ckpt')
